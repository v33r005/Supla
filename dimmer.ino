...
void setup() {
  ...
  auto sciemniacz = new Supla::Control::DimmerLeds(
      BRIGHTNESS_PIN);
  ...
  button->addAction(Supla::DIM_ALL, sciemniacz, Supla::ON_HOLD);
  button->addAction(Supla::BRIGHTEN_ALL, sciemniacz, Supla::ON_CLICK_1);
